...
struct_8SSZ93PxvPkADZcA4gG8MD rtP_Sensors ; const char *
...
#endif
static void mdlInitializeConditions ( SimStruct * S ) { uint8_T * o_o_B_26_2
= ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; ha1ipjbq54 ( o_o_B_26_2 ) ;
...
o_B_26_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; uint8_T *
o_o_B_26_2 = ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid == 0 )
{ flightControlSystemTID0 ( i_bdony3ptwc , o_B_26_1 , o_o_B_26_2 ) ;
...
i_bdony3ptwc = ( SensorsBus * ) ssGetInputPortSignal ( S , 1 ) ; real32_T *
o_B_26_1 = ( real32_T * ) ssGetOutputPortSignal ( S , 0 ) ; uint8_T *
o_o_B_26_2 = ( uint8_T * ) ssGetOutputPortSignal ( S , 1 ) ; if ( tid ==
PARAMETER_TUNING_TID ) { flightControlSystemTID2 ( ) ; } if ( tid !=
CONSTANT_TID && tid != PARAMETER_TUNING_TID ) { if ( ssIsSampleHit ( S , 0 ,
tid ) ) { flightControlSystemTID0 ( i_bdony3ptwc , o_B_26_1 , o_o_B_26_2 ) ;
...
mr_flightControlSystem_GetDWork ( ) ; mxSetFieldByNumber ( ss , 0 , 1 ,
mdlrefDW ) ; } { mxArray * data =
